...
def Fourier_filter(x, threshold, scale):
    # FFT
    # print('In Fourier Filter', x.shape)
    x = x.float()
    # x = torch.nn.functional.interpolate(x, size=(16, 16), mode='bilinear')
    ...
    x_filtered = x_filtered.half()
    # x_filtered = torch.nn.functional.interpolate(x_filtered, size=(12, 12), mode='bilinear')
    return x_filtered
