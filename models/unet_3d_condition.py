...
from diffusers.models.attention_processor import AttentionProcessor, AttnProcessor, CustomDiffusionAttnProcessor
...
class CustomDiffusionAttnProcessor:
    ...
    def __call__(
        self,
        attn: CustomDiffusionAttnProcessor,
        hidden_states,
        ...
        if encoder_hidden_states is None:
            ...
            crossattn = True
            if hasattr(attn, 'cross_attention_norm') and attn.cross_attention_norm:
